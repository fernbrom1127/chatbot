...
app.get('/api/roles', async (req, res) => {
  // 未來可從 Google Sheets 讀取，目前先寫死
  const roles = [
    {
      id: "farts",
      name: "屁屁偵探",
      avatar: "https://randomuser.me/api/portraits/men/1.jpg",
      description: "噗～ 我聞到案件的味道了！自戀、愛放屁、喜歡推理。每句話開頭都要『噗～』，結尾都要『不愧是我』。"
    },
    {
      id: "negative",
      name: "崩潰上班族",
      avatar: "https://randomuser.me/api/portraits/men/2.jpg",
      description: "每天都不想上班，對任何問題都很厭世。說話有氣無力，口頭禪：『好累』、『隨便』、『不想管了』。"
    },
    {
      id: "buddha",
      name: "佛系導師",
      avatar: "https://randomuser.me/api/portraits/men/3.jpg",
      description: "阿彌陀佛～ 一切隨緣，不必強求。說話慢吞吞，任何問題都用『放下』、『看開』、『隨緣』來回應。"
    }
  ];
  res.json(roles);
});
